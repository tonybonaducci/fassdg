...
def AGE_aritmetico(train_set, test_set, train_set_size, test_set_size,weights,atributes):
    ...
    while(n_evaluaciones<5):
        ...
        mejor_fit, peor, segundo_peor, i_mejor, i_peor, i_segundo_peor = valor_poblacion_age(poblacion,train_set, test_set, train_set_size, test_set_size,atributes,tam_poblacion)
        n_evaluaciones = n_evaluaciones + len(poblacion)
